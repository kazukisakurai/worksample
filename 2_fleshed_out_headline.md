...
そのおかげで、集団開発の際にも、後付けの複雑な設定に混乱することも少なくなります。
...
しかし、Railsはその登場以前の他既存フレームワークに比べ、シンプルな構造をもっており、そのメリットを最大限に活かすことができます。
...
MVCは、Model・View・Controllerの頭文字ですね。

MVCフレームワークでは、プログラム全体をこの３つの要素に分類しています。突き詰めていくと複雑ですが、まずは、わかりやすく簡潔に考えてみましょう。

つぶやき投稿サイトの投稿一覧のページを思い浮かべてください。

たくさんの情報が表示されていますが、どれがどの要素に該当しているのでしょうか。

まずModelに該当する要素としては、投稿者名やつぶやきの内容。新規投稿の入力欄や、いいねボタンなんかも、Modelに属しています。

Viewに該当するのは、webブラウザに表示されている画面のレイアウトです。通常のwebサイトと同じく、ヘッダーなどが固定されていることに注目してください。このviewの作成で、学んできたHTMLやCSSの技術が活かされます。

Controllerはというと、これは画面上で確認することはできません。どこに、どの順番で、どの投稿者のつぶやきを、表示させるかなどを裏で管理しています。指示された内容をModelから拾ってきて、Viewに渡しているんですね。
